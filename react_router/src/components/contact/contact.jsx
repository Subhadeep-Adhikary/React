                ...
                <div className="mt-8 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg">
                            ...
                            <div className="flex items-center mt-8 text-gray-600">
                                ...
                                <div className="ml-4 text-md tracking-wide font-semibold w-40">
                                    Acme Inc, Public Street, State, Postal Code
                                </div>
                            </div>
                        ...
                        <form className="p-6 flex flex-col justify-center" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button
                                type="submit"
                                className="md:w-32 bg-orange-700 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:opacity-90 transition ease-in-out duration-300"
                            >
                                Submit
                            </button>
                        </form>
